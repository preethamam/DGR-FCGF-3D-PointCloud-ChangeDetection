...
from core.fully_convolutional_geometric_features import FullyConvolutionalGeometricFeatures
...
if __name__ == '__main__':
  ...
  # registration
  fcgf = FullyConvolutionalGeometricFeatures(config)
  T01, rmse = fcgf.register(pcd0, pcd1)
